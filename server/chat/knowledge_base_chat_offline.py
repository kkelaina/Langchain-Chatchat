...
async def knowledge_base_chat_offline(query: str = Body(..., description="用户输入", examples=["你好"]),
    ...
    async def knowledge_base_chat_iterator(
        ...
        # 将文档内容连接成一个字符串，以便后续使用
        context = "\n".join([doc.page_content for doc in docs])

        source_documents = []

        # 通过迭代docs，构建source_documents和相关的URL
        ...
        # 使用单个yield输出JSON响应，确保只有一次HTTP请求
